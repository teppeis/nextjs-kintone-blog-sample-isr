export const REPO_URL =
  "https://github.com/teppeis/nextjs-kintone-blog-sample-isr";
export const CMS_NAME = "Kintone";
export const CMS_URL = "https://www.kintone.com/";
export const BLOG_TITLE = "Next.js + Kintone Blog (ISR)";
